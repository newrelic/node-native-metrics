...
provide pre-built Linux and macOS binaries for Node v0.10, v0.12, and v4-v7. If
you are not using Linux or macOS, or are using a version of Node other than
we've listed above you will need to have a compiler installed on the machine
where this is to be deployed.
